                ...
                <div class="col-12">
                    <div class="header-elements">
                        ...
                        <div class="main-menu-ex  homepage8 homepage7 ">
                            <ul>
                                <li class="mega-dropdawn"><a href="{{ route("home") }}">Home </a>

                                </li>
                                <li><a href="{{ route("aboutUs") }}" class="font-ks font-16 weight-500 color">About
                                        Us</a></li>
                                <li><a href="#faq" class="font-ks font-16 weight-500 color">FAQ's</a></li>
...
<div class="mobile-sidebar" style="background-color: #0B111F;">
    ...
    <div class="mobile-nav">
        ...
        <ul class="mobile-nav-list">
            <li><a href="{{ route("home") }}" class="font-ks font-16 weight-500 color">Home </a>

            </li>

            <li><a href="{{ route("aboutUs") }}" class="font-ks font-18 weight-600 color">About Us </a></li>

            <li><a href="#faq" class="font-ks font-16 weight-500 color">FAQ's</a>
